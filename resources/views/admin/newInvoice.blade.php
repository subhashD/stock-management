...
<div class="card bg-white animated slideInRight">
  	...
  	<form class="form-horizontal" role="form" action="/saveInvoice" method="POST" id="quoteForm">
  	{{ csrf_field() }}
  	<div class="row m-a-0">
       <div class="col-md-12">
        <div class="row">
            ...
            <div class="col-md-6">
              <div class="form-group">
                ...
                <div class="col-sm-9">
                  <input name="inv_no" id="inv_no" type="text" class="form-control" placeholder="Invoice number." value="{{isset($invoice)?($client->tax=='yes'?$invoice->tax_invoice:$invoice->notax_invoice):$invoice_no}}" readonly>
                </div>
              </div>
            </div> 
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                ...
                <div class="col-sm-9">
                  <input type="text" name="estimate_date" id="estimate_date" class="form-control m-b" data-provide="datepicker" id="startDatePicker" placeholder="Invoice Date" value="{{isset($invoice)?date('m/d/Y',strtotime($invoice->invoice_date)):''}}" required>
                </div>
              </div>
            </div>
            <div class="col-md-6">
              <div class="form-group">
                ...
                <div class="col-sm-9">
                  <input type="text" name="due_date" id="expiry_date" class="form-control m-b" data-provide="datepicker" id="endDatePicker" placeholder="Due Date" value="{{isset($invoice)?date('m/d/Y',strtotime($invoice->due_date)):''}}" required>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="row">
            <div class="col-xs-12">
            <button type="button" class="btn btn-info" data-toggle="modal" data-target="#servicesModal"><i class="fa fa-plus"></i> Add More Products</button>
             <div class="table-responsive">
                ...
                <table class="table table-bordered table-striped m-b-0">
                  ...
                  @if(isset($invoice) || isset($estimate))
         ...
         <div class="row">
            ...
            <div class="col-md-5 pull-right">
              ...
              <div class="row">
                <div class="col-sm-4">
                  <input type="text" class="form-control" name="adjustment[]" value="{{isset($invoice)?$adjustment[0]:(isset($estimate)?$adjustment[0]:'Adjustment')}}">
                </div>
                ...
                <div class="col-sm-6 pull-right">
                    ...
                    <span class="input-group-addon">
                      ...
                      <input type="text" class="form-control" name="adjustment[]" id="adjustment" min="0" onchange="refreshCost()" value="{{isset($invoice)?$adjustment[1]:(isset($estimate)?$adjustment[1]:'')}}">
                    </div>
                </div>
              </div> 
          ...
          <div class="row">
               ...
               <span data-toggle="collapse" data-target="#terms_cond" class="terms text-primary">Terms & Conditions <i class="fa fa-plus" id="terms_icon"></i></span>
                    ...
                    <div id="terms_cond" class="collapse">
                      <textarea class="summernote" name="terms" rows="10" placeholder="Enter Some text ...">{{isset($invoice)?$invoice->terms_condition:''}}</textarea>
                    </div> 
              ...
              <tbody>
                @foreach($items as $item)
                  <tr>
                    ...
                    <input type="hidden" value="{{$item->id}}" class="service_id">
                    <td class="col-md-8">
    ...
    while(true){
        if($(".qty").eq(i).val()!='' && $(".rate").eq(i).val()){
         ...
         else
         {
          ...
          //   var availQty = parseInt($(".service_qty").eq(i).val());
          //   var p_id = parseInt($(".service_id").eq(i).val());
          //   if(id == p_id)
          //   {
          //     alert(p_id);
          //     if(availQty < qt)
          //       alert("The Availabel Quantity is "+availQty+" You can not use more than that!");
          //   }
          //   else
          //   {
          //     return true;
